...
#
# [실행 형식]
# # python p190872_local_chk_v07_gm.py <검색기준테이블> <검색디렉토리> <검색결과테이블명> [--mid <MID목록>] [--db] [--conf <설정파일>] [--where <old|new>] [--chk <default|encdec_no|all>]
#
# [실행 예시]
...
# # python p190872_local_chk_v07_gm.py my_db.my_ref_table D:\chksrc\sources my_db.my_result_table --mid aaa --db --chk all
#
# [수정 이력]
# ─────────────────────────────────────────────────────────────
# v05_gm (2026-06-16)
...
# ============================================================
# DB 테이블 DDL 및 적재 모듈 (9차 및 10차 수정)
# ============================================================
_DDL_CREATE_RESULT = """
